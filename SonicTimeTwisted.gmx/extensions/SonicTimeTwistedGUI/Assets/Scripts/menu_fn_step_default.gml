...
switch(state)
{
    ...
    case 18:
        ...
        if(timer >= 10)
        {
            ...
            if(((state == 11 && confirmation_cursor == 0) || (state == 15 && confirmation_cursor >= 0)) && confirmation_yes_action != -1)
            {
            ...
            else
            {
                ...
                if(((state == 11) || (state == 15 && confirmation_cursor == -1)) && confirmation_no_action != -1)
                {
