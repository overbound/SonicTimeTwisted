if (input_method_autodetected == INPUT_TOUCHSCREEN) {
    ...
    switch(input_manage_script) {
        case input_method_touchscreen_abs:
            input_manage_script = input_method_android_touchscreen_abs;
            break;
        case input_method_touchscreen_rel:
            input_manage_script = input_method_android_touchscreen_rel;
            break;
        case input_method_ssgyro_rel:
            input_manage_script = input_method_android_ssgyro_rel;
            break;
        case input_method_ssgyro_abs:
            input_manage_script = input_method_android_ssgyro_abs;
            break;
        case input_method_ggpoint:
            input_manage_script = input_method_android_ggpoint;
            break;
        default:
