switch(argument0)
{
    ...
    case -1:
        ...
        {
            menu_fn_open_confirmation_window(tr("_menu_Remap_Incomplete"), 21, 11, false, tr("_menu_Remap_Redo"), tr("_menu_Remap_Reset"));
        }        
        break;
    case 0:
    ...
    case 1:
        ...
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_Up")), cUP, 10);
        break;
    case 2:
        // individual map - button Down
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_Down")), cDOWN, 10);
        break;
    case 3:
        // individual map - button Left
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_Left")), cLEFT, 10);
        break;
    case 4:
        // individual map - button Right
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_Right")), cRIGHT, 10);
        break;
    case 5:
        // individual map - button A
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_A")), cA, 10);
        break;
    case 6:
        // individual map - button B
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_B")), cB, 10);
        break;
    case 7:
        // individual map - button C
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_C")), cC, 10);
        break;
    case 8:
        // individual map - button Start
        menu_fn_open_mapping_window(tr_format(tr("_menu_Remap_Press"), tr("_menu_buttonname_Start")), cSTART, 10);
        break;
    case 10:
