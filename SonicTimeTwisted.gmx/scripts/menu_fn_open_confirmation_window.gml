...
var button_width = max(string_width_ext(confirmation_yes_label, 0, view_width - 4*margin), string_width_ext(confirmation_no_label, 0, view_width - 4*margin));
var buttons_width = button_width * 2 + 96;

internal__draw_confirmation_width = max(text_width, buttons_width);
...
internal__draw_confirmation_yes_button_x2 = internal__draw_menu_rect_x_center - 12;
internal__draw_confirmation_no_button_x1 = internal__draw_menu_rect_x_center + 4;
internal__draw_confirmation_no_button_x2 = internal__draw_confirmation_rect_x2 - margin - 8;
