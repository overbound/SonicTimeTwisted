...
if not objScreen.split_screen draw_text_colour(argument2+122 + top_hud_offset, argument3+8, objGameData.player_score[view_current], c_white, c_white, c_white, c_white, 1);
draw_text_colour(argument2+122 + top_hud_offset, argument3+40-(16*objScreen.split_screen), argument1, c_white, c_white, c_white, c_white, 1);
draw_text_colour(argument2+122 + top_hud_offset, argument3+24-(16*objScreen.split_screen), time_stamp, c_white, c_white, c_white, c_white, 1);
draw_set_halign(fa_left);
