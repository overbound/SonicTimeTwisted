...
if (room == room_first && global.EAS_state == EASYASYNC_STATE.LOADING && !instance_exists(objProgram))
{
 with (instance_create(0, 0, objProgram)) event_perform(ev_other, ev_game_start);
}
